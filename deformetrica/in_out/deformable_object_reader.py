...
from deformetrica.core.observations.deformable_objects.landmarks.point_cloud import (
    PointCloud,
)
from deformetrica.core.observations.deformable_objects.landmarks.poly_line import (
    PolyLine,
)
from deformetrica.core.observations.deformable_objects.landmarks.surface_mesh import (
    SurfaceMesh,
)
from deformetrica.in_out.image_functions import normalize_image_intensities
    ...
    def create_object(object_filename, object_type, dimension=None):
        if object_type.lower() in [
            ...
            if object_type.lower() == "SurfaceMesh".lower():
                ...
                try:
                    points, dimension, connectivity = (
                        DeformableObjectReader.read_vtk_file(
                            object_filename, dimension, extract_connectivity=True
                        )
                    )
