...
from deformetrica.core import GpuMode, default
...
from deformetrica.core.models.affine_atlas import AffineAtlas
from deformetrica.core.models.bayesian_atlas import BayesianAtlas
from deformetrica.core.models.deterministic_atlas import DeterministicAtlas
from deformetrica.core.models.geodesic_regression import GeodesicRegression
from deformetrica.core.models.longitudinal_atlas import LongitudinalAtlas
from deformetrica.core.models.principal_geodesic_analysis import (
    PrincipalGeodesicAnalysis,
)
from deformetrica.core.models.spline_regression import SplineRegression
from deformetrica.core.models.volume_constrained_shooting import (
    VolumeConstrainedShooting,
)
...
from deformetrica.launch.compute_parallel_transport import compute_parallel_transport
from deformetrica.launch.compute_shooting import compute_shooting
from deformetrica.launch.estimate_longitudinal_registration import (
...
class Deformetrica:
    ...
    def estimate_registration(
        ...
        # NB (L): `freeze_template` is forced to True
        ...
        # NB (L): kwargs cleanup
        for name in ("gpu_mode",):
            del estimator_options[name]
    ...
    def estimate_longitudinal_atlas(
        ...
        assert (
            not dataset.is_cross_sectional() and not dataset.is_time_series()
    ...
    def estimate_spline_regression(
        ...
        assert (
            dataset.is_time_series()
        ), "Cannot estimate a spline regression from a non-time-series dataset."
    ...
    def estimate_volume_constrained_shooting(
        ...
        dataset = {
            "target": target_vol,
            "subject_size": data_sizes,
            "number_of_subjects": len(target_vol),
    ...
    def further_initialization(
        ...
        if dataset_specifications is None or estimator_options is None:
            assert (
                model_type.lower() in ["Shooting".lower(), "ParallelTransport".lower()]
