...
class Type(Enum):
    ...
    from deformetrica.support.kernels.polynomial_torch_kernel import PolynomialKernel
...
def factory(kernel_type, cuda_type=None, gpu_mode=None, *args, **kwargs):
    ...
    if hash not in instance_map:
        res = kernel_type.value(
            gpu_mode=gpu_mode, cuda_type=cuda_type, *args, **kwargs
        )  # instantiate
