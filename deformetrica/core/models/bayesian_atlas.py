...
from deformetrica.support.probability_distributions.inverse_wishart_distribution import (
...
from deformetrica.support.probability_distributions.normal_distribution import (
    NormalDistribution,
)
