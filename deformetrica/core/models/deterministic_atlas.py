...
import deformetrica.support.utilities as utilities
...
from deformetrica.in_out.deformable_object_reader import vtkPolyDataReader
        ...
        if with_grad:
            ...
            if not freeze_template:
                if "landmark_points" in template_data.keys():
                    assert (
                        template_points["landmark_points"].grad is not None
                ...
                if "image_intensities" in template_data.keys():
                    assert (
                        template_data["image_intensities"].grad is not None
                    ), "Gradients have not been computed"
            ...
            if not freeze_control_points:
                assert (
                    control_points.grad is not None
                ), "Gradients have not been computed"
