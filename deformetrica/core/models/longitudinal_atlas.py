...
from deformetrica.core.model_tools.deformations.spatiotemporal_reference_frame import (
    SpatiotemporalReferenceFrame,
)
from deformetrica.core.models.abstract_statistical_model import AbstractStatisticalModel
from deformetrica.core.models.model_functions import (
...
from deformetrica.in_out.dataset_functions import (
...
from deformetrica.support.probability_distributions.multi_scalar_truncated_normal_distribution import (
...
class LongitudinalAtlas(AbstractStatisticalModel):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        assert (
            self.number_of_sources is not None
